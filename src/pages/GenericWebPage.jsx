  ...
  return (
    <div className="min-h-screen bg-vedam-cream relative pb-24 overflow-hidden font-sans text-vedam-charcoal">
      <header className="bg-white px-6 py-4 border-b border-gray-200 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3"><Globe className="w-8 h-8 text-vedam-gold" /><h2 className="text-xl md:text-2xl font-bold font-heading text-vedam-charcoal">{title}</h2></div>
      ...
      <main className="container mx-auto px-6 lg:px-16 pt-24 relative z-10 text-center">
        ...
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl md:text-6xl font-heading font-bold text-vedam-charcoal mb-8">
          {title}
        </motion.h1>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="max-w-5xl mx-auto mb-24">
          <div className="bg-gray-900 p-3 md:p-4 rounded-t-[2rem] md:rounded-t-[3rem] shadow-2xl relative mx-auto" style={{ maxWidth: '85%' }}>
            ...
            <div className="bg-white rounded-xl md:rounded-2xl overflow-hidden aspect-video relative group">
              ...
              <div className="absolute inset-0 bg-vedam-charcoal/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                <button className="px-8 py-4 bg-white text-vedam-charcoal font-bold rounded-full shadow-2xl hover:scale-105 transition-transform">Interactive Preview Coming Soon</button>
              </div>
            </div>
          </div>
          {/* Laptop Base */}
        ...
        <div id="how-it-works" className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-vedam-charcoal/10 text-vedam-gold rounded-xl flex items-center justify-center mb-6"><Smartphone className="w-6 h-6" /></div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-vedam-charcoal/10 text-vedam-gold rounded-xl flex items-center justify-center mb-6"><Monitor className="w-6 h-6" /></div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-vedam-charcoal/10 text-vedam-gold rounded-xl flex items-center justify-center mb-6"><Globe className="w-6 h-6" /></div>
