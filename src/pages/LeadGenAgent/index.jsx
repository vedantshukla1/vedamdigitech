      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
          <div className="p-6 border-b border-gray-100 flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity" onClick={onBack}>
            ...
            <h1 className="text-xl font-heading font-bold text-black tracking-tight">AI Lead Agent</h1>
          </div>
          <div className="flex-1 p-4 space-y-2">
            <div className="flex items-center gap-3 px-4 py-3 bg-vedam-blue/10 text-vedam-blue rounded-xl font-medium cursor-pointer">
              <Search className="w-5 h-5" />
              Find Leads
            </div>
            <div className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl font-medium cursor-pointer transition-colors">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-50/50 relative">
          ...
          <header className="bg-white px-8 py-6 border-b border-gray-200 flex items-center justify-between sticky top-0 z-10 shadow-sm">
            <h2 className="text-2xl font-bold font-heading text-black">New Search</h2>
            ...
            <div className="hidden md:flex items-center gap-4">
              <div className="text-sm font-medium text-gray-500">Credits: <span className="text-black font-bold">1,240</span></div>
              <div className="w-10 h-10 bg-gradient-to-tr from-vedam-blue to-vedam-gold rounded-full flex items-center justify-center text-white font-bold shadow-md">
                VD
              </div>
            </div>
          </header>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-vedam-blue/10 rounded-2xl flex items-center justify-center text-vedam-blue">
                      <Bot className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-black font-heading">Configure Lead Agent</h3>
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center justify-center py-20">
                <div className="relative mb-12">
                  ...
                  <div className="w-32 h-32 bg-white rounded-full border-4 border-gray-50 shadow-2xl flex items-center justify-center relative z-10">
                    <Loader2 className="w-12 h-12 text-vedam-blue animate-spin" />
                  </div>
                  {/* Floating particles */}
            ...
            {status === 'done' && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                ...
                <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="grid grid-cols-12 gap-4 p-6 bg-gray-50 border-b border-gray-200 font-bold text-sm text-gray-500 uppercase tracking-wider">
                  ...
                  <div className="divide-y divide-gray-100">
                    {mockLeads.map((lead) => (
                      <div key={lead.id} className="grid grid-cols-12 gap-4 p-6 items-center hover:bg-gray-50/50 transition-colors">
                        <div className="col-span-4">
                          <div className="font-bold text-black text-lg flex items-center gap-2"><Building2 className="w-4 h-4 text-gray-400"/> {lead.company}</div>
              ...
              >
                <div className="bg-gray-50 p-6 border-b border-gray-100 flex justify-between items-center">
                  <div>
                    ...
                    <div className="font-medium text-black">To: {selectedLead.email}</div>
                  </div>
                ...
                <div className="p-8">
                  <div className="w-full p-6 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 whitespace-pre-wrap leading-relaxed font-medium">
                  ...
                  <div className="mt-8 flex justify-end gap-4">
                    ...
                    <button onClick={() => setSelectedLead(null)} className="px-8 py-3 bg-vedam-blue hover:bg-blue-700 text-white font-bold rounded-xl transition-colors flex items-center gap-2 shadow-lg shadow-vedam-blue/30">
