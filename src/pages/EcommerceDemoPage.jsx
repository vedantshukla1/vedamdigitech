  ...
  return (
    <div className="min-h-screen bg-white relative pb-24 font-sans text-vedam-charcoal">
      <header className="bg-white px-6 py-4 border-b border-gray-200 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3"><ShoppingBag className="w-8 h-8 text-vedam-gold" /><h2 className="text-xl md:text-2xl font-bold font-heading text-vedam-charcoal">E-commerce Platform</h2></div>
      ...
      <section className="pt-20 pb-12 px-6 lg:px-16 text-center max-w-5xl mx-auto">
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-5xl md:text-7xl font-heading font-bold text-vedam-charcoal mb-6">Headless Storefront</motion.h1>
      ...
      <section className="py-16 px-6 lg:px-16 bg-vedam-cream border-y border-gray-200 relative">
        ...
        <motion.div layout className={`mx-auto bg-white border border-gray-300 shadow-2xl overflow-hidden flex flex-col transition-all duration-500 z-50 ${isFrontendFullscreen ? 'fixed inset-0 w-full h-full rounded-none m-0' : 'max-w-6xl h-[800px] rounded-2xl relative'}`}>
          ...
          <div className="flex-1 overflow-auto bg-white text-left font-sans">
            ...
            {/* Promo Banner */}
            <div className="bg-vedam-charcoal text-white text-xs font-bold text-center py-2 tracking-widest uppercase">
            ...
            <nav className="bg-white py-6 px-8 flex justify-between items-center border-b border-gray-100 sticky top-0 z-40">
              <div className="flex items-center gap-4">
                <Menu className="w-6 h-6 text-vedam-charcoal md:hidden"/>
                <div className="text-vedam-charcoal font-black text-2xl tracking-tighter uppercase">HYPERKICKS</div>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="relative cursor-pointer hover:opacity-70 transition-opacity">
                  ...
                  <span className="absolute -top-2 -right-2 bg-vedam-charcoal text-white text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full">0</span>
                </div>
              </div>
            </nav>
              ...
              <div className="py-8 lg:py-4 flex flex-col">
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-1 text-sm font-bold">
                      <Star className="w-4 h-4 fill-black text-vedam-charcoal"/> 4.9 <span className="text-gray-400 underline cursor-pointer ml-1">(124 Reviews)</span>
                    </div>
                  </div>
                  <h1 className="text-4xl sm:text-5xl font-black uppercase tracking-tight mb-4">Nike Air Max Pro</h1>
                  <p className="text-2xl font-bold text-vedam-charcoal">$145.00</p>
                </div>
                ...
                <div className="mb-8">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-gray-500 text-sm underline cursor-pointer hover:text-vedam-charcoal">Size Guide</span>
                  </div>
                  <div className="grid grid-cols-4 sm:grid-cols-5 gap-3">
                    {["8", "8.5", "9", "9.5", "10", "10.5", "11", "11.5", "12", "13"].map((size) => (
                      <button key={size} className={`py-3 border border-gray-300 rounded-lg font-bold hover:border-black hover:bg-vedam-charcoal hover:text-white transition-colors ${size === "10" ? "border-black bg-vedam-charcoal text-white" : ""}`}>{size}</button>
                    ))}
                  </div>
                </div>
                
                <button onClick={() => { setAdded(true); setTimeout(() => setAdded(false), 2000); }} className={`w-full py-5 font-black uppercase tracking-widest rounded-full text-lg transition-all shadow-xl ${added ? 'bg-green-500 text-white shadow-green-500/30' : 'bg-vedam-charcoal text-white hover:bg-gray-800 shadow-black/20'}`}>
                  {added ? "Added to Cart ✓" : "Add to Cart"}
                </button>

                {/* AI Recommendation Widget */}
                <div className="mt-12 bg-indigo-50 border border-indigo-100 p-6 rounded-2xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 bg-vedam-charcoal text-white text-xs font-bold px-3 py-1 rounded-bl-xl flex items-center gap-1"><Sparkles className="w-3 h-3"/> AI Suggestion</div>
                  ...
                  <div className="flex items-center gap-4 bg-white p-3 rounded-xl border border-indigo-100 shadow-sm">
                    ...
                    <button className="px-4 py-2 bg-vedam-charcoal text-white font-bold text-xs uppercase tracking-widest rounded-lg hover:bg-gray-800 transition-colors">Add</button>
                  </div>
                </div>

                <div className="mt-12 border-t border-gray-200 pt-8 space-y-4 text-sm font-bold text-gray-500 uppercase tracking-widest">
                  <div className="flex justify-between cursor-pointer hover:text-vedam-charcoal"><span>Free Delivery & Returns</span> <span>+</span></div>
                  <div className="flex justify-between cursor-pointer hover:text-vedam-charcoal"><span>Product Details</span> <span>+</span></div>
                </div>
              </div>
            </div>

            {/* Simulated Footer */}
            <footer className="bg-vedam-charcoal text-white py-20 px-8 mt-24">
      ...
      <section className="py-20 px-6 lg:px-16 bg-white">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row h-auto md:h-[600px] rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
          <div className="w-full md:w-64 bg-vedam-charcoal text-white p-6 flex flex-col">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Zap className="w-10 h-10 text-vedam-gold mb-4" />
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <ShoppingBag className="w-10 h-10 text-vedam-gold mb-4" />
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Percent className="w-10 h-10 text-vedam-gold mb-4" />
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Package className="w-10 h-10 text-vedam-gold mb-4" />
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <Search className="w-10 h-10 text-vedam-gold mb-4" />
