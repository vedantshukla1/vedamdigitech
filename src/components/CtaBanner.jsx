...
const CtaBanner = () => {
  return (
    <section className="py-24 bg-vedam-charcoal relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-vedam-charcoal/20 rounded-full blur-[100px]"></div>
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10 text-center">
        ...
        >
          <a href="#contact" className="px-8 py-4 bg-white text-vedam-charcoal font-bold text-lg rounded-full hover:bg-gray-100 transition-colors shadow-xl">
            Start a Project
          </a>
