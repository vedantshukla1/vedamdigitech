...
const Testimonials = () => {
  const testimonials = [
    { name: "Rahul S.", company: "TechFlow", text: "Vedam Digitech completely transformed our user acquisition. Their AI lead gen system booked 40 meetings in the first month.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" },
  ...
  return (
    <section className="py-24 bg-vedam-cream overflow-hidden relative">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="absolute top-1/2 -translate-y-1/2 -left-4 md:-left-12 z-20">
            <button onClick={prev} className="w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-vedam-charcoal hover:bg-vedam-charcoal hover:text-white transition-colors">
              <ChevronLeft className="w-6 h-6" />
            </button>
          </div>
          
          <div className="absolute top-1/2 -translate-y-1/2 -right-4 md:-right-12 z-20">
            <button onClick={next} className="w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-vedam-charcoal hover:bg-vedam-charcoal hover:text-white transition-colors">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <img src={testimonials[current].image} alt={testimonials[current].name} className="w-16 h-16 rounded-full object-cover border-2 border-vedam-gold/20" />
                  <div>
                    <h4 className="text-lg font-bold text-vedam-charcoal font-heading">{testimonials[current].name}</h4>
