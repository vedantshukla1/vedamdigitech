...
const InteractiveDemo = () => {
  ...
  return (
    <section id="agent-demo" className="py-24 bg-vedam-cream relative border-t border-gray-100 overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-vedam-charcoal/5 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 translate-x-1/3"></div>
      
      <div className="container mx-auto px-6 lg:px-16">
        <div className="text-center max-w-3xl mx-auto mb-16 relative z-10">
          <motion.div 
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            className="inline-flex items-center gap-2 py-1 px-3 rounded-full bg-vedam-charcoal/10 text-vedam-gold font-bold text-xs tracking-wider uppercase mb-6"
          >
            <Sparkles className="w-4 h-4" /> Try It Live
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
            className="text-4xl md:text-5xl font-heading font-bold text-vedam-charcoal mb-6"
          >
        ...
        >
          ...
          {/* Browser Content */}
          <div className="p-8 md:p-12 min-h-[500px] bg-vedam-cream/50 relative">
                ...
                <motion.div key="idle" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="max-w-3xl mx-auto">
                  <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                    <div className="flex items-center gap-4 mb-8">
                      <div className="w-14 h-14 bg-vedam-charcoal/10 rounded-2xl flex items-center justify-center text-vedam-gold">
                        <Bot className="w-8 h-8" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-vedam-charcoal font-heading">Configure Campaign</h3>
                ...
                <motion.div key="generating" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center py-10">
                  <div className="relative mb-12">
                    ...
                    <div className="w-24 h-24 bg-white rounded-full border-4 border-gray-50 shadow-xl flex items-center justify-center relative z-10">
                      <Loader2 className="w-10 h-10 text-vedam-gold animate-spin" />
                    </div>
                  </div>
              ...
              {status === 'done' && (
                <motion.div key="done" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                  ...
                  <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className="hidden md:grid grid-cols-12 gap-4 p-4 bg-vedam-cream border-b border-gray-200 font-bold text-xs text-gray-500 uppercase tracking-wider">
                    ...
                    <div className="divide-y divide-gray-100">
                      {mockLeads.map((lead) => (
                        <div key={lead.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-6 items-center hover:bg-vedam-cream/50 transition-colors">
                          <div className="col-span-1 md:col-span-4">
                            <div className="font-bold text-vedam-charcoal md:text-lg flex items-center gap-2"><Building2 className="w-4 h-4 text-gray-400"/> {lead.company}</div>
        ...
        <AnimatePresence>
          {selectedLead && (
            <motion.div 
              ...
              className="absolute inset-0 z-50 bg-vedam-charcoal/50 backdrop-blur-sm flex items-center justify-center p-4 rounded-2xl"
              ...
              >
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="mt-6 flex justify-end gap-3">
                    ...
                    <button onClick={() => setSelectedLead(null)} className="px-6 py-2 bg-vedam-charcoal hover:bg-black text-white text-sm font-bold rounded-xl transition-colors flex items-center gap-2 shadow-lg shadow-vedam-gold/30">
        ...
        <div id="how-it-works" className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto relative z-10">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
            <div className="w-14 h-14 bg-vedam-charcoal/10 text-vedam-gold rounded-2xl flex items-center justify-center font-bold text-2xl font-heading mb-6">1</div>
            <h3 className="text-xl font-bold text-vedam-charcoal font-heading mb-3">Define Audience</h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
            <div className="w-14 h-14 bg-vedam-charcoal/10 text-vedam-gold rounded-2xl flex items-center justify-center font-bold text-2xl font-heading mb-6">2</div>
            <h3 className="text-xl font-bold text-vedam-charcoal font-heading mb-3">AI Deep Search</h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
            <div className="w-14 h-14 bg-vedam-charcoal/10 text-vedam-gold rounded-2xl flex items-center justify-center font-bold text-2xl font-heading mb-6">3</div>
            <h3 className="text-xl font-bold text-vedam-charcoal font-heading mb-3">Hyper-Personalize</h3>
        ...
        <div className="mt-16 text-center relative z-10">
          <a href="#contact" className="inline-flex items-center gap-2 px-10 py-5 bg-vedam-charcoal text-white font-bold text-lg rounded-full hover:bg-gray-800 transition-all shadow-2xl hover:shadow-black/20 hover:-translate-y-1">
